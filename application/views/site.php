                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="<?php echo base_url(); ?>index.php/backend/login">Login</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/1.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/2.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/3.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/4.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/5.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/destination/6.png" alt="">
                        </div>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/1.png" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/2.png" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                            <a href="destination_details.html">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/3.png" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                            <a href="destination_details.html">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/4.png" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                            <a href="destination_details.html">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/5.png" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                            <a href="destination_details.html">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/place/6.png" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                            <a href="destination_details.html">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/resources/img/svg_icon/1.svg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/resources/img/svg_icon/2.svg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="<?php echo base_url(); ?>/resources/img/svg_icon/3.svg" alt="">
                        </div>
                        <h3>Travel Guide</h3>
                        <p>A wonderful serenity has taken to the possession of my entire soul.</p>
                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="<?php echo base_url(); ?>/resources/img/testmonial/author.png" alt="">
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/trip/1.png" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/trip/2.png" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                                <span>Oct 12, 2019</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        <div class="thumb">
                            <img src="<?php echo base_url(); ?>/resources/img/trip/3.png" alt="">
                        </div>
                        <div class="info">
                            <div class="date">
                                <span>Oct 12, 2019</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="<?php echo base_url(); ?>/resources/img/footer_logo.png" alt="">
                                </a>
                            </div>
                        ...
                        <div class="footer_widget">
                            ...
                            <div class="instagram_feed">
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/1.png" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/2.png" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/3.png" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/4.png" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/5.png" alt="">
                                    </a>
                                </div>
                                <div class="single_insta">
                                    <a href="#">
                                        <img src="<?php echo base_url(); ?>/resources/img/instagram/6.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
